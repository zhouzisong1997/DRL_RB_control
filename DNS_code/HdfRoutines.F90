...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      ...
      subroutine HdfCreateBlankFile00(filename)
            use hdf5
            implicit none
      ...
      end subroutine HdfCreateBlankFile00
...
!====================================================================
      subroutine HdfSerialWriteReal1D00(dsetname,filename,var,sz)
            use hdf5
            implicit none
            character*200,intent(in) :: dsetname,filename
            integer, intent(in) :: sz
            real, dimension(sz), intent(in) :: var
            integer(HID_T) :: file_id
            integer(HID_T) :: dset, filespace
           ...
           &   var(1:sz), dims, hdf_error)
            ...
            end subroutine HdfSerialWriteReal1D00
!====================================================================
...
!====================================================================
      subroutine HdfSerialReadReal1D00(dsetname,filename,var,sz)
            use hdf5
            implicit none
            character*200,intent(in) :: dsetname,filename
            integer, intent(in) :: sz
           ...
           &   var, dims, hdf_error)
            ...
            end subroutine HdfSerialReadReal1D00
!====================================================================
