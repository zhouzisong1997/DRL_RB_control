...
!==========================================================
        ...
        real      :: walltimemax,tout,tmax,tout1,iftest
        real      :: alx3,str3
        integer   :: istr3
        real      :: ylen,zlen
...
!===========================================================
!******* active control on the wall ************************
        !real :: alpha_ac, beta_ac
        real, allocatable, dimension(:,:) :: T_ac_low,T_ac_upp
        character(len=100) :: local_tmpdir
