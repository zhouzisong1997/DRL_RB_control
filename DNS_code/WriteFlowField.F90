...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      ...
      subroutine WriteFlowField_mid(Istep)
            use param
            use local_arrays, only: vz,vy,vx,temp
            implicit none
            integer :: Istep
            ...
            filnam1 = trim('channel_'//numsave//'_vx.h5')
            call HdfWriteRealHalo3D(filnam1,vx)
            filnam1 = trim('channel_'//numsave//'_vy.h5')
            call HdfWriteRealHalo3D(filnam1,vy)
            filnam1 = trim('channel_'//numsave//'_vz.h5')
            call HdfWriteRealHalo3D(filnam1,vz)
            filnam1 = trim('channel_'//numsave//'_temp.h5')
            call HdfWriteRealHalo3D(filnam1,temp)
      

      end subroutine WriteFlowField_mid
